<template>
      ...
      <div class="plane-down">
        <div v-for="(t,index) in ticketList" :key="index">
          ...
          <div class="planeMsg">
            ...
            <div class="planeName">{{ t.planeName }}</div>
          </div>
          <div class="toTime">
          ...
          <div class="price">
            <div class="p-price">￥{{ t.firstPrice }}</div>
            <div class="p-amount">
              {{ t.firstAmount }}
            </div>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        lightBorder2: "none",
        ticketList:[
          {fTime:'07:00',fStation:'首都国际机场T2',totleTime:'2时20分',planeName:'空客320-NEO',tTime:'09:20',tStation:'浦东国际机场T1',firstAmount:'公务舱',firstPrice:1495,showTicketList: false,},
          {fTime:'07:30',fStation:'首都国际机场T2',totleTime:'2时20分',planeName:'波音737',tTime:'09:50',tStation:'浦东国际机场T2',firstAmount:'公务舱',firstPrice:5490,showTicketList: false,},
          {fTime:'07:15',fStation:'大兴国际机场',totleTime:'2时15分',planeName:'空客330',tTime:'09:15',tStation:'虹桥国际机场T2',firstAmount:'经济舱',firstPrice:760,showTicketList: false,},
          {fTime:'07:00',fStation:'首都国际机场T2',totleTime:'2时20分',planeName:'空客320-NEO',tTime:'09:20',tStation:'浦东国际机场T1',firstAmount:'经济舱',firstPrice:850,showTicketList: false,},
        ]
      };
    },
    methods: {
  ...
  .plane-up {
    width: 100%;
    height: 280px;
    background-image: url(~@/assets/bck3.jpg);
